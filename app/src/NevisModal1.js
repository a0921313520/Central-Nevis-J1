...
class NevisModal extends React.Component {
    ...
    render() {
        ...
        const { passwordModal, repeatModal, newSettingModal, showFace, showFinger, faceUpperLimit, faceIdLoginUpperLimit, fingerPrintLoginUpperLimit, homepageSetModal, faceLoginUpperLimit, closeSettingModal, alreadySettingModal, pwlVerification, invalidCodeModal, validCodeModal, toastSuccessFlag, noMoreTimes, } = this.state;
